...
using static BakerMonkeNameSpace.BakerMonkeyModV2;
...
[assembly: MelonInfo(typeof(BakerMonkeNameSpace.BakerMonkeyModV2), ModHelperData.Name, ModHelperData.Version, ModHelperData.RepoOwner)]
...
namespace BakerMonkeNameSpace
{
    ...
    public class BakerMonkeyModV2 : BloonsTD6Mod
    {
        ...
        public class BakerMonkey : ModTower
        {
            ...
            public override string Description => "WIP V2";
